...
const rows = [
  ...
  createData(2,'인천국제공항제2여객터미널','기타관광',"1,841,745"),
  createData(3,'현대프리미엄아울렛송도점','쇼핑',"846,156"),
  createData(4,'월미도','자연관광',"562,970"),
  createData(5,'을왕리해수욕장','자연관광',"530,371"),
];

function IncheonBeforeTable() {
  return (
    <>
    <div>
      <h3 align= "center">인천 관광지 검색순위(코로나 전)</h3>
    </div>
    <div>
...
export default IncheonBeforeTable;