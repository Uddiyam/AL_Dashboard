...
class JejuLine extends React.Component {
  componentDidMount() {
  ...
  renderMultiChart() {
    ...
    let after = [
      ...
      859877, 884541, 385229, 261648, 448631, 564074, 759000, 896070, 776636,
...
function Before() {
  ...
  let natural = [
    ...
    629053, 720881, 565535, 802283, 621649, 559005,
  ];
  let tourism = [
