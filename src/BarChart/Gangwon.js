...
class Gangwon extends React.Component {
  componentDidMount() {
  ...
  renderMultiChart() {
    let before = [3019206,2159451,	2072021	,3048139	,4056030,	3332135	,3834049,	4559689,	3283643	,4739476	,2948645,	2901310	,
        	3609820	,2995672,	2502090	,2722069	,3692170,	3594189,	3565731,	5041598,	2953056,	5002100	,3000688,	2881902];
    let after = [3302356,1970976	,1173559,	1274825,	2218805,	2069803	,2404946,	2993446	,1453406	,3358761	,2196059	,1070537	,
    ...
    lines
      .append("text")
      .style("font-size", "0.8em")
      .attr("transform", "translate(" + 600 + "," + 210 + ")")
      .attr("dy", ".500em")
      .attr("text-anchor", "start")
      .style("fill", "red")
      .text("코로나 전");
...
function Before() {
    let culture = [134447 ,	102304 	,125273, 	192688 ,	253947 	,177033 ,	172070 	,231370 ,	195938 ,	340645 ,	194582 ,	166054 	
         	,169721, 	180975 ,	193704 ,	222431 ,	243043, 	251388 ,	188277 ,	270055 ,	183900 	,332317 	,199260, 	170902 ];
    let natural = [129133 ,	97102 ,	141046 	,226512 ,	407126 ,	282751, 	344212 ,	531980 ,	256391 	,356522 ,	145707 	,150792 ,	
         	271616, 	235893 ,	210204 	,247840 ,	412989 ,	399183 ,	400579 ,	661171, 	305284, 	590035 	,354809, 	261997 ];
    let tourism = [2755626,	1960045,	1805702	,2628939,	3394957	,2872351	,3317767	,3796339,	2831314	,4042309	,2608356,	2584464	,
...
function After() {
    let culture = [180950 ,	112264 ,	119077 ,	130639,	205575 ,	170111 ,	196961 ,	243276 	,162807 ,	308182 ,	209506 ,127844 	,
         	111041 	,163764 	,111556 ,	154231 ,	206363, 	177136, 	164551 	,218181, 	181550 ,	258258, 	214276 	,140863 ];
    let natural = [337210 ,	270216 ,	206335 	,185691 ,	337543 ,	282955 	,309536 	,381219, 	187681 ,	481101 ,	279020, 	80253 	,
         	95435, 	188910 ,	138646 ,	208780, 	332004, 	282978 ,	345887 ,	410993 ,	253919 ,	488838 ,	250244 	,147192 ];
    let tourism = [2784196,	1588496	,848147,	958495,	1675687,	1616737,	1898449	,2368951,	1102918,	2569478	,1707533,	862440	,
