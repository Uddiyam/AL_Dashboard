...
class Gyeonggi extends React.Component {
  ...
  renderMultiChart() {
    let before = [3266058 ,	3383708 ,	4685724 ,	6420163 ,8663663 	,7192358 ,	6112136 ,	6942948 ,	7491753 	,9251992, 	5879490, 	4551657 	,
         	3779908 	,4008625, 	5060154 ,	7598617, 	9310923 ,	7731101 ,	6118629 ,	7843706 ,6409503 ,	9116533 ,	6071822 ,	3983079 ];
    let after = [3681540 ,2041007 ,	2701194 ,	3300995, 	4317158 ,	3185247 ,	3686682 ,	2870067 ,	3066783 ,	5860594 ,	3684283 ,	1756180 	
...
function Before() {
    let culture = [201408 ,	234775 ,	392422 ,	550489 	,741481 ,551743 	,347935 ,	375402 ,	672702 ,	708796 ,	404912 ,	218406 	,
         	397982, 	252390 ,	349836 	,540436 ,	886960 ,	532989 	,358177 	,428933 ,	467387 	,731837 	,464179 ,	273341 ];
    let natural = [120869 ,	175613 	,228159 	,311192 ,	451189 	,508253 	,607684 	,474397 ,	540422 	,543328 	,256373 ,	191687 
        	, 	337270 	,399433 ,	556823 	,719669 ,	917218 ,	930563 ,	714911 	,770007 	,760933 ,	888486 	,552826 ,	320502   ];
    let tourism = [2943781,	2973320	,4065143,	5558482	,7470993,6132362,5156517,	6093149,	6278629	,7999868,	5218205,	4141564	,
  ...
  lines
    ...
    .attr("transform", "translate(" + 615 + "," + 260 + ")")
    .attr("dy", ".500em")
    .attr("text-anchor", "start")
  ...
  lines
    .append("text")
    .style("font-size", "0.7em")
    .attr("transform", "translate(" + 615 + "," + 425 + ")")
    .attr("dy", ".500em")
    .attr("text-anchor", "start")
  ...
  lines
    .append("text")
    .style("font-size", "0.7em")
    .attr("transform", "translate(" + 615 + "," + 445 + ")")
    .attr("dy", ".530em")
    .attr("text-anchor", "start")
...
function After() {
    let culture = [272777 ,	169056 	,298162 ,	407729, 	442589 	,117913 ,	252494 ,	265331 	,366884 ,	627336 	,378523 ,213040 	,
         	214514 ,	312148, 	291220, 	442786 	,580326 ,	563896 ,	237700 	,337276 ,	624832 	,628423 ,	471232 ,245109 ];
    let natural = [381858 ,	405065 	,808504 ,	696997, 	803562, 	698327 ,	895936 ,	490384, 	562470 ,	950564 	,643945 ,	482413 	,
         	412703 ,	483487, 	522874, 	719327, 	779839 	,718442 ,	645167 ,	892924, 	1051441 ,	921798, 	644183, 	451198];
    let tourism = [3026905,	1466886	,1594528	,2196269,	3071007	,2369007	,2538252	,2114352,	2137429,	4282694	,2661815	,1060727	,
  ...
  lines
    ...
    .append("text")
    .style("font-size", "0.7em")
    .attr("transform", "translate(" + 615 + "," + 300 + ")")
    .attr("dy", ".500em")
    .attr("text-anchor", "start")
    .style("fill", d3.schemeCategory10[2])
    .text("관광 시설");
