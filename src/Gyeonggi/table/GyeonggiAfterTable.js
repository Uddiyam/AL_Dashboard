...
const rows = [
  ...
  createData(2,'스타필드고양','쇼핑',"2,122,156"),
  createData(3,'현대프리미엄아울렛김포점','쇼핑',"1,691,765"),
  createData(4,'신세계프리미엄아울렛여주점(EAST)','쇼핑',"1,455,577"),
  createData(5,'이케아고양점','쇼핑',"1,422,149"),
];

function GyeonggiAfterTable() {
  return (
    <>
    <div>
      <h3 align= "center">경기도 관광지 검색순위(코로나 후)</h3>
    </div>
    <div>
...
export default GyeonggiAfterTable;