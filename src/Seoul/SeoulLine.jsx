...
function Before() {
  ...
  lines
    ...
    .attr("transform", "translate(" + 590 + "," + 155 + ")")
    .attr("dy", ".500em")
    .attr("text-anchor", "start")
...
function After() {
  let culture = [
    811883, 293522, 291454, 415345, 402882, 58249, 125905, 192525, 296788,
  ...
  lines
    .append("text")
    .style("font-size", "0.7em")
    .attr("transform", "translate(" + 580 + "," + 365 + ")")
    .attr("dy", ".500em")
    .attr("text-anchor", "start")
    .style("fill", d3.schemeCategory10[0])
    .text("문화");
  ...
  lines
    .append("text")
    .style("font-size", "0.7em")
    .attr("transform", "translate(" + 580 + "," + 450 + ")")
    .attr("dy", ".530em")
    .attr("text-anchor", "start")
    .style("fill", d3.schemeCategory10[1])
    .text("자연 및 생태환경");
